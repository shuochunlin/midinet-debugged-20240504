...
class sample_generator(nn.Module):
    ...
    def forward(self, z, prev_x, y ,batch_size,pitch_range):
        ...
        # was a temporary hotfix for y to force 1D representation
...
class discriminator(nn.Module):
    ...
    def forward(self,x,y,batch_size,pitch_range):
        ...
        # print("After concat (x, yb)):", x.shape)
        
        h0 = lrelu(self.h0_prev(x),0.2)   #### THIS line
        # print("After h0:", h0.shape)
        fm = h0
        h0 = conv_cond_concat(h0, yb) #torch.Size([72, 27, 8, 1])
        # print("After concat (h0, yb):", h0.shape)
        ...
        # print("Before torch cat (h1):", h1.shape)
        h1 = torch.cat((h1,y),1)  #torch.Size([72, 244])
        # print("After torch cat (h1):", h1.shape)
